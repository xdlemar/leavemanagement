            ...
            <div class="side-menu px-4 py-6">
                 <ul class="space-y-4">
                   ...
                   <div class="menu-option">
                    ...
                    <div class="menu-option">
                        <a href="../apply.php" class="menu-name flex justify-between items-center space-x-3 hover:bg-[#F7E6CA] px-4 py-3 rounded-lg transition duration-300 ease-in-out cursor-pointer">
                            <div class="flex items-center space-x-2">
                                <i class="fa-solid fa-house text-lg pr-4"></i>
                    ...
                    <div class="menu-option">
                     ...
                     <!-- Disbursement Item  -->
                        ...
                        <div class="menu-option">
<!-- Disbursement Item  -->
                        <div class="menu-name flex justify-between items-center space-x-3 hover:bg-[#F7E6CA] px-4 py-3 rounded-lg transition duration-300 ease-in-out cursor-pointer" onclick="window.location.href='manageleave.php'">
                            <div class="flex items-center space-x-2">  
                                <a href="manageleave.php">                              
                                <span  href="manageleave.php" class="text-sm font-medium">Leave Request</span>
</a>
                            </div>
                           
                        </div>
                        <div class="menu-name flex justify-between items-center space-x-3 hover:bg-[#F7E6CA] px-4 py-3 rounded-lg transition duration-300 ease-in-out cursor-pointer" onclick="window.location.href='leavehistory.php'">
                            <div class="flex items-center space-x-2">  
                                <a href="leavehistory.php">                              
                                <span   class="text-sm font-medium">Leave History</span>
</a>
                            </div>
                            
                        </div>
                        <div class="menu-name flex justify-between items-center space-x-3 hover:bg-[#F7E6CA] px-4 py-3 rounded-lg transition duration-300 ease-in-out cursor-pointer" onclick="window.location.href='addleave.php'">
                            <div class="flex items-center space-x-2">  
                                <a href="addleave.php">                              
                                <span  class="text-sm font-medium">Manage Leave Types</span>
</a>
                            </div>
